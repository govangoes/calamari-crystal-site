  ...
  return (
    <main className="relative isolate overflow-hidden">
      ...
      <section className="mx-auto flex w-full max-w-6xl flex-col gap-16 px-4 py-16 sm:px-6 lg:px-8">
        ...
        <section className="relative overflow-hidden rounded-3xl border border-dashed border-white/20 bg-slate-900/60 p-10 text-center shadow-[0_0_50px_-25px_rgba(16,185,129,0.9)]">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-base text-violet-100">
            Dive into our 8-bit styled Calamari Crystal directory of kava bars, hookah lounges, nightlife hubs, and archived venues all across Orlando.
          </p>
          <a
            href="/orlando-nightlife.html"
            className="group mt-6 inline-flex items-center gap-2 rounded-full border border-emerald-300/60 bg-emerald-500/30 px-6 py-3 text-base font-semibold text-emerald-200 transition hover:border-emerald-200 hover:bg-emerald-400/40 hover:text-paperWhite"
          >
